        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-gradient-to-br from-indigo-600 to-indigo-700 p-6 rounded-lg text-white shadow-xl shadow-indigo-100">
                    ...
                    <div className="text-3xl font-semibold mb-1">{repairs.filter(r => ['Tamamlandı', 'Teslim Edildi'].includes(r.status)).length}</div>
                    <div className="text-xs font-bold text-xs uppercase tracking-wide opacity-80">Toplam Biten Onarım</div>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm">
                    ...
                    <div className="text-3xl font-semibold text-gray-900 mb-1">{repairs.filter(r => r.status?.includes('İşlem')).length}</div>
                    <div className="text-xs font-bold text-xs uppercase tracking-wide text-gray-400">Aktif Onarımlar</div>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm">
                    ...
                    <div className="text-3xl font-semibold text-gray-900 mb-1">~42 dk</div>
                    <div className="text-xs font-bold text-xs uppercase tracking-wide text-gray-400">Ort. Tamir Hızı</div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-lg border border-gray-100 shadow-sm overflow-hidden">
                <div className="p-8 border-b border-gray-100">
                    ...
                    <p className="text-xs text-gray-400 font-bold text-xs uppercase tracking-wide mt-1">Gerçek Zamanlı Performans Analizi</p>
                </div>
                <div className="overflow-x-auto">
                    <table className="w-full text-left">
                        <thead className="bg-gray-50/50 text-[10px] font-semibold uppercase text-gray-400 tracking-widest border-b border-gray-100">
                            <tr>
                                    ...
                                    <tr key={tech.id} className="hover:bg-gray-50/50 transition-all group">
                                        <td className="px-8 py-6">
                                            <div className="flex items-center gap-3">
                                                <div className="w-10 h-10 bg-indigo-50 text-indigo-600 rounded-md flex items-center justify-center font-semibold">
                                        ...
                                        <td className="px-6 py-6 font-semibold text-gray-700">{stats.completed}</td>
                                        <td className="px-6 py-6 font-semibold text-orange-500">{stats.active}</td>
                                        ...
                                        <td className="px-8 py-6 text-right">
                                            <span className={`px-2.5 py-1 rounded-lg text-[9px] font-semibold text-xs uppercase tracking-wide ${
